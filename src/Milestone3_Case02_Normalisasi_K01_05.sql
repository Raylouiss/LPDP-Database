...
--
-- Host: localhost    Database: sistem_final
-- ------------------------------------------------------
...
--
-- Table structure for table `passing_grade_seleksi`
--

DROP TABLE IF EXISTS `passing_grade_seleksi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `passing_grade_seleksi` (
  `ID_Seleksi` varchar(20) NOT NULL,
  `Passing_Grade` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_Seleksi`),
  CONSTRAINT `passing_grade_ibfk_1` FOREIGN KEY (`ID_Seleksi`) REFERENCES `seleksi_lanjutan` (`ID_Seleksi`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `passing_grade_seleksi`
--

LOCK TABLES `passing_grade_seleksi` WRITE;
/*!40000 ALTER TABLE `passing_grade_seleksi` DISABLE KEYS */;
INSERT INTO `passing_grade_seleksi` VALUES
('C000550',80),
('C003372',80),
('C005675',80),
('C005939',80),
...
('E963402',80),
('E980305',80);
/*!40000 ALTER TABLE `passing_grade_seleksi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pelaksanaan_kesehatan`
--

DROP TABLE IF EXISTS `pelaksanaan_kesehatan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pelaksanaan_kesehatan` (
  `ID_Seleksi` varchar(20) NOT NULL,
  `Tanggal_Pelaksanaan` date NOT NULL,
  `ID_Dokter` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`ID_Seleksi`),
  KEY `pelaksanaan_kesehatan_ibfk_2` (`ID_Dokter`),
  CONSTRAINT `pelaksanaan_kesehatan_ibfk_1` FOREIGN KEY (`ID_Seleksi`) REFERENCES `seleksi_kesehatan` (`ID_Seleksi`),
  CONSTRAINT `pelaksanaan_kesehatan_ibfk_2` FOREIGN KEY (`ID_Dokter`) REFERENCES `dokter` (`ID_Panitia`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pelaksanaan_kesehatan`
--

LOCK TABLES `pelaksanaan_kesehatan` WRITE;
/*!40000 ALTER TABLE `pelaksanaan_kesehatan` DISABLE KEYS */;
INSERT INTO `pelaksanaan_kesehatan` VALUES
('E007550','2023-05-31','B95273'),
('E035542','2023-05-23','B20096'),
('E041495','2023-05-27','B54461'),
('E045066','2023-05-27','B60666'),
('E072419','2023-05-31','B30653'),
('E080521','2023-05-23','B79793'),
('E087524','2023-05-27','B88889'),
('E096267','2023-05-23','B46600'),
('E105903','2023-05-28','B54534'),
('E109865','2023-05-23','B43977'),
('E116783','2023-05-23','B54461'),
('E133574','2023-05-24','B76959'),
('E135716','2023-05-27','B97808'),
('E136996','2023-05-28','B95620'),
('E142909','2023-05-23','B54534'),
('E160352','2023-05-27','B02266'),
('E176099','2023-05-26','B48221'),
('E179505','2023-05-26','B64014'),
('E186682','2023-05-27','B66846'),
('E190687','2023-05-27','B43977'),
('E193109','2023-05-31','B88889'),
('E196500','2023-05-28','B46600'),
('E213905','2023-05-22','B16085'),
('E215253','2023-05-26','B76959'),
('E228953','2023-05-22','B43977'),
('E236003','2023-05-28','B23709'),
('E240352','2023-05-24','B16085'),
('E242580','2023-05-26','B19774'),
('E255472','2023-05-26','B97808'),
('E258886','2023-05-30','B95273'),
('E263957','2023-05-25','B74141'),
('E265183','2023-05-28','B54534'),
('E273293','2023-05-22','B48221'),
('E274233','2023-05-27','B48221'),
('E299635','2023-05-27','B62553'),
('E302800','2023-05-31','B46600'),
('E329657','2023-05-31','B62553'),
('E333080','2023-05-22','B97808'),
('E336901','2023-05-24','B07066'),
('E343857','2023-05-26','B12745'),
('E347542','2023-05-25','B36330'),
('E368513','2023-05-27','B11318'),
('E382811','2023-05-22','B07066'),
('E398752','2023-05-27','B26580'),
('E403434','2023-05-26','B37004'),
('E412705','2023-05-27','B34408'),
('E417896','2023-05-23','B26580'),
('E418476','2023-05-25','B34408'),
('E430860','2023-05-25','B64014'),
('E435856','2023-05-30','B19774'),
('E451599','2023-05-24','B23744'),
('E452222','2023-05-27','B79793'),
('E452412','2023-05-27','B02266'),
('E455311','2023-05-26','B60666'),
('E456836','2023-05-25','B97808'),
('E473716','2023-05-22','B53031'),
('E475709','2023-05-27','B36330'),
('E483535','2023-05-29','B97808'),
('E485248','2023-05-28','B53031'),
('E491413','2023-05-24','B97808'),
('E495434','2023-05-23','B23744'),
('E497023','2023-05-24','B62553'),
('E497181','2023-05-22','B78006'),
('E497271','2023-05-30','B02266'),
('E498468','2023-05-23','B04157'),
('E514372','2023-05-23','B54534'),
('E516460','2023-05-30','B64014'),
('E527019','2023-05-28','B64014'),
('E532927','2023-05-25','B32876'),
('E535180','2023-05-27','B30653'),
('E544015','2023-05-27','B11318'),
('E547951','2023-05-22','B95273'),
('E564462','2023-05-31','B07066'),
('E569495','2023-05-24','B71369'),
('E574187','2023-05-30','B07801'),
('E575172','2023-05-23','B56487'),
('E581741','2023-05-22','B95273'),
('E593142','2023-05-23','B37004'),
('E600855','2023-05-29','B64014'),
('E602196','2023-05-28','B78006'),
('E640634','2023-05-23','B50576'),
('E641602','2023-05-25','B43977'),
('E658888','2023-05-22','B88889'),
('E673961','2023-05-25','B12072'),
('E681273','2023-05-28','B37004'),
('E681620','2023-05-25','B12349'),
('E683461','2023-05-26','B97752'),
('E683958','2023-05-27','B71369'),
('E687332','2023-05-28','B19774'),
('E698792','2023-05-31','B37004'),
('E713347','2023-05-29','B32876'),
('E722262','2023-05-23','B95620'),
('E729403','2023-05-30','B37004'),
('E729810','2023-05-31','B78006'),
('E745438','2023-05-25','B26580'),
('E750785','2023-05-24','B12072'),
('E752349','2023-05-30','B04157'),
('E752661','2023-05-30','B99568'),
('E754471','2023-05-26','B12745'),
('E787950','2023-05-24','B53031'),
('E788253','2023-05-30','B04157'),
('E795418','2023-05-31','B16085'),
('E797688','2023-05-27','B48221'),
('E798053','2023-05-22','B43977'),
('E800566','2023-05-31','B53031'),
('E811822','2023-05-22','B78006'),
('E823960','2023-05-30','B37004'),
('E845606','2023-05-30','B23709'),
('E847382','2023-05-27','B97808'),
('E850366','2023-05-31','B48221'),
('E854888','2023-05-24','B36330'),
('E878006','2023-05-29','B66846'),
('E900013','2023-05-28','B64014'),
('E905540','2023-05-25','B64014'),
('E907143','2023-05-25','B20096'),
('E911870','2023-05-25','B74141'),
('E936137','2023-05-23','B23709'),
('E942183','2023-05-24','B75690'),
('E947161','2023-05-25','B60666'),
('E948173','2023-05-24','B66846'),
('E961294','2023-05-27','B53031'),
('E963050','2023-05-23','B71369'),
('E963402','2023-05-26','B54534'),
('E980305','2023-05-29','B07723');
/*!40000 ALTER TABLE `pelaksanaan_kesehatan` ENABLE KEYS */;
UNLOCK TABLES;
...
('1275094','RS Advent Medan','Medan'),
('3171795','RSUD Pasar Minggu','Jakarta Selatan'),
('3171801','RSUD Kebayoran Baru','Jakarta Selatan'),
('3172206','RS Premier Jatinegara','Jakarta Timur'),
('3173014','RSUPN dr. Cipto Mangunkusumo','Jakarta Pusat'),
('3273074','RS Santo Borromeus','Bandung'),
('3273464','RS Unpad Bandung','Bandung'),
('3402084','RSUD Kota Yogyakarta','Yogyakarta'),
('3578213','RSUD Bhakti Dharma Husada','Surabaya'),
('7171102','RS Umum Manado Medical Center','Manado');
...
('D002013',1,'C','B41546',98),
('D003283',5,'E','B61611',74),
('D008047',4,'D','B38537',79),
('D008984',3,'D','B35245',86),
('D015455',2,'B','B03664',94),
('D017143',4,'A','B17599',100),
('D019300',1,'A','B96647',93),
('D021107',1,'A','B96647',96),
('D021800',4,'E','B70221',72),
('D041547',5,'C','B33920',95),
('D048768',2,'E','B73627',72),
('D049703',1,'D','B36118',87),
('D062639',5,'A','B21565',79),
('D063779',1,'E','B15082',95),
('D065123',4,'A','B17599',70),
('D066533',5,'C','B33920',73),
('D072766',3,'A','B53053',75),
('D075110',1,'B','B55774',79),
('D078844',4,'E','B70221',87),
('D085060',4,'A','B17599',87),
('D086522',2,'A','B65729',76),
('D089638',2,'C','B42207',94),
('D090518',1,'E','B15082',73),
('D096566',1,'A','B96647',83),
('D099271',3,'E','B89526',88),
('D106864',1,'A','B96647',77),
('D107252',2,'D','B14014',74),
('D108028',1,'A','B96647',96),
('D115097',4,'A','B17599',83),
('D115969',4,'B','B37973',78),
('D118895',1,'B','B55774',82),
('D125467',1,'E','B15082',99),
('D128794',5,'C','B33920',84),
('D133550',1,'B','B55774',90),
('D134515',3,'B','B03058',95),
('D137055',2,'B','B03664',88),
('D153752',4,'D','B38537',82),
('D155200',5,'E','B61611',95),
('D162134',5,'C','B33920',71),
('D165801',5,'C','B33920',91),
('D166250',5,'E','B61611',93),
('D180797',4,'A','B17599',86),
('D182076',4,'C','B51316',92),
('D183231',5,'D','B23460',100),
('D190508',5,'A','B21565',71),
('D193686',3,'D','B35245',78),
('D194079',3,'B','B03058',73),
('D195522',4,'D','B38537',93),
('D205609',4,'B','B37973',92),
('D206039',2,'C','B42207',74),
('D214115',3,'C','B64748',91),
('D218784',1,'B','B55774',87),
('D223121',5,'C','B33920',84),
('D224458',2,'C','B42207',92),
('D230401',2,'E','B73627',89),
('D235790',4,'D','B38537',87),
('D239265',2,'B','B03664',98),
('D243017',1,'E','B15082',92),
('D244838',5,'A','B21565',86),
('D245030',3,'B','B03058',78),
('D246250',3,'E','B89526',94),
('D256741',4,'A','B17599',81),
('D258716',1,'E','B15082',87),
('D258901',5,'C','B33920',84),
('D269490',2,'A','B65729',89),
('D278219',4,'B','B37973',72),
('D285780',1,'E','B15082',76),
('D294905',5,'A','B21565',71),
('D307063',1,'B','B55774',80),
('D307736',5,'B','B71605',72),
('D330213',4,'D','B38537',84),
('D337075',4,'E','B70221',96),
('D348113',2,'B','B03664',98),
('D349025',1,'A','B96647',79),
('D349536',5,'C','B33920',76),
('D352000',3,'B','B03058',96),
('D360325',1,'B','B55774',72),
('D361278',2,'D','B14014',70),
('D362010',1,'B','B55774',94),
('D364054',2,'D','B14014',86),
('D368735',1,'B','B55774',77),
('D372590',2,'A','B65729',82),
('D375191',2,'B','B03664',89),
('D379018',1,'B','B55774',94),
('D380317',1,'C','B41546',98),
('D382421',4,'C','B51316',83),
('D383568',5,'B','B71605',95),
('D386264',5,'E','B61611',78),
('D394375',2,'B','B03664',88),
('D398016',5,'A','B21565',99),
('D398296',3,'D','B35245',83),
('D398906',3,'C','B64748',73),
('D408900',4,'A','B17599',87),
('D418374',2,'C','B42207',94),
('D425268',4,'E','B70221',87),
('D425639',4,'D','B38537',81),
('D427083',3,'C','B64748',99),
('D433760',5,'E','B61611',70),
('D434498',4,'C','B51316',89),
('D434765',1,'B','B55774',75),
('D435906',4,'E','B70221',82),
('D444536',5,'A','B21565',73),
('D452852',2,'E','B73627',79),
('D456339',2,'E','B73627',89),
('D457752',1,'E','B15082',99),
('D459537',5,'C','B33920',72),
('D464729',5,'C','B33920',90),
('D465941',1,'B','B55774',83),
('D470736',5,'B','B71605',85),
('D473106',5,'B','B71605',100),
('D477544',4,'D','B38537',92),
('D478838',3,'E','B89526',81),
('D482131',5,'E','B61611',99),
('D483056',2,'E','B73627',77),
('D484400',3,'B','B03058',70),
('D487199',1,'A','B96647',87),
('D492454',3,'B','B03058',93),
('D497071',5,'B','B71605',72),
('D497207',2,'C','B42207',90),
('D500872',4,'D','B38537',99),
('D501965',3,'A','B53053',82),
('D509532',4,'A','B17599',76),
('D513921',3,'C','B64748',95),
('D515347',1,'D','B36118',96),
('D517108',5,'B','B71605',88),
('D519944',5,'C','B33920',97),
('D522790',1,'A','B96647',76),
('D529526',2,'A','B65729',89),
('D529597',1,'D','B36118',80),
('D530212',3,'B','B03058',80),
('D536024',3,'D','B35245',70),
('D537795',1,'B','B55774',79),
('D541014',3,'D','B35245',99),
('D542332',3,'B','B03058',75),
('D545374',3,'B','B03058',74),
('D551402',5,'C','B33920',82),
('D553472',4,'A','B17599',94),
('D555698',1,'A','B96647',74),
('D558364',2,'B','B03664',77),
('D562549',4,'C','B51316',70),
('D563588',5,'E','B61611',90),
('D567383',3,'A','B53053',91),
('D572291',5,'C','B33920',85),
('D574713',5,'A','B21565',100),
('D577083',2,'A','B65729',76),
('D580683',1,'B','B55774',71),
('D582955',5,'C','B33920',85),
('D588400',1,'C','B41546',100),
('D588426',5,'A','B21565',93),
('D591839',4,'E','B70221',72),
('D592939',5,'E','B61611',95),
('D596673',1,'B','B55774',96),
('D596875',3,'E','B89526',76),
('D605817',5,'A','B21565',74),
('D606307',2,'B','B03664',76),
('D607016',4,'A','B17599',97),
('D619397',2,'A','B65729',74),
('D623792',5,'A','B21565',81),
('D624641',3,'B','B03058',94),
('D626737',2,'A','B65729',70),
('D627244',2,'A','B65729',76),
('D627271',4,'E','B70221',77),
('D627975',1,'B','B55774',100),
('D629155',5,'C','B33920',72),
('D645996',4,'D','B38537',88),
('D646227',3,'B','B03058',77),
('D648324',2,'A','B65729',94),
('D652449',5,'E','B61611',93),
('D654408',4,'C','B51316',98),
('D655409',3,'E','B89526',95),
('D658164',3,'C','B64748',71),
('D664199',5,'E','B61611',83),
('D664563',3,'D','B35245',81),
('D673464',2,'A','B65729',72),
('D674042',1,'A','B96647',86),
('D675582',1,'D','B36118',96),
('D676510',3,'C','B64748',73),
('D683582',5,'E','B61611',97),
('D683816',5,'E','B61611',90),
('D688187',5,'B','B71605',90),
('D690121',1,'C','B41546',93),
('D692157',5,'B','B71605',96),
('D692218',4,'C','B51316',81),
('D694793',1,'A','B96647',90),
('D698917',1,'D','B36118',95),
('D703006',4,'B','B37973',73),
('D703139',4,'B','B37973',96),
('D705098',4,'D','B38537',80),
('D708077',1,'A','B96647',84),
('D710134',3,'D','B35245',89),
('D710263',4,'E','B70221',77),
('D712390',2,'B','B03664',90),
('D714418',4,'B','B37973',94),
('D714738',4,'C','B51316',97),
('D715606',4,'D','B38537',73),
('D717818',1,'B','B55774',72),
('D731311',2,'C','B42207',89),
('D732026',1,'C','B41546',97),
('D732393',4,'B','B37973',78),
('D737514',2,'A','B65729',89),
('D738516',3,'C','B64748',77),
('D744150',2,'A','B65729',87),
('D744381',4,'A','B17599',72),
('D744942',2,'E','B73627',71),
('D746234',4,'E','B70221',73),
('D749530',5,'A','B21565',89),
('D753306',5,'E','B61611',74),
('D764851',3,'B','B03058',100),
('D769346',4,'A','B17599',90),
('D774501',2,'E','B73627',70),
('D775062',1,'D','B36118',81),
('D775085',2,'C','B42207',71),
('D792430',4,'E','B70221',95),
('D793615',5,'D','B23460',73),
('D804092',2,'A','B65729',89),
('D813709',2,'D','B14014',80),
('D816681',5,'B','B71605',76),
('D823410',5,'B','B71605',74),
('D828711',2,'B','B03664',90),
('D830786',2,'A','B65729',98),
('D832936',1,'D','B36118',79),
('D833450',5,'B','B71605',83),
('D839840',1,'C','B41546',94),
('D845198',5,'D','B23460',81),
('D852792',1,'C','B41546',70),
('D861027',1,'A','B96647',93),
('D864719',2,'B','B03664',83),
('D871232',3,'E','B89526',79),
('D877618',5,'C','B33920',74),
('D884420',2,'C','B42207',77),
('D886003',4,'C','B51316',78),
('D889232',3,'A','B53053',80),
('D897322',5,'A','B21565',85),
('D907707',5,'C','B33920',71),
('D909536',4,'E','B70221',80),
('D914872',1,'C','B41546',92),
('D918301',3,'A','B53053',98),
('D927557',3,'E','B89526',99),
('D929227',4,'C','B51316',91),
('D932281',4,'A','B17599',84),
('D932645',3,'D','B35245',87),
('D934702',4,'B','B37973',70),
('D938034',4,'D','B38537',84),
('D939307',4,'B','B37973',86),
('D939442',4,'E','B70221',90),
('D945381',4,'A','B17599',79),
('D949178',2,'E','B73627',83),
('D951337',3,'B','B03058',86),
('D951580',5,'A','B21565',97),
('D952462',3,'C','B64748',82),
('D977842',5,'C','B33920',81),
('D978497',5,'D','B23460',91),
('D981719',1,'E','B15082',70),
('D997039',1,'C','B41546',81);
...
('C000550',2,'Daring','B47707',76),
('C003372',3,'Daring','B36934',82),
('C005675',1,'Daring','B27929',100),
('C005939',1,'Daring','B75754',100),
('C009736',3,'Daring','B96651',90),
('C015240',2,'Daring','B49208',75),
('C017027',3,'Daring','B47707',86),
('C021199',2,'Daring','B81408',81),
('C027719',2,'Daring','B81408',96),
('C033562',3,'Daring','B47707',81),
('C035208',3,'Daring','B05226',84),
('C044793',3,'Daring','B47707',97),
('C049933',3,'Daring','B75754',86),
('C051727',2,'Daring','B31388',99),
('C054158',3,'Daring','B47707',79),
('C055607',1,'Daring','B27929',77),
('C064123',3,'Daring','B66779',85),
('C064678',3,'Daring','B96651',100),
('C065234',3,'Daring','B78354',100),
('C070211',3,'Daring','B52187',84),
('C070414',3,'Daring','B96651',98),
('C071549',2,'Daring','B49208',87),
('C071949',3,'Daring','B05575',86),
('C074833',1,'Daring','B66905',95),
('C083485',2,'Daring','B31388',75),
('C085361',3,'Daring','B36934',82),
('C092042',2,'Daring','B81408',100),
('C095941',1,'Daring','B78354',99),
('C096065',3,'Daring','B36934',75),
('C097392',2,'Daring','B31388',76),
('C098694',3,'Daring','B75754',98),
('C104502',3,'Daring','B75754',96),
('C109721',2,'Daring','B96651',82),
('C110327',3,'Daring','B47707',93),
('C118838',3,'Daring','B05226',99),
('C121825',2,'Daring','B96651',88),
('C122928',2,'Daring','B49491',75),
('C133668',1,'Daring','B66905',99),
('C134646',1,'Daring','B27929',76),
('C137653',2,'Daring','B49208',86),
('C138581',1,'Daring','B78354',91),
('C140985',3,'Daring','B96651',95),
('C147284',2,'Daring','B96651',75),
('C151684',3,'Daring','B47707',91),
('C156235',2,'Daring','B31388',97),
('C156261',1,'Daring','B58031',88),
('C162285',3,'Daring','B36934',78),
('C165999',1,'Daring','B75754',94),
('C172382',2,'Daring','B81408',78),
('C174453',3,'Daring','B96651',88),
('C174857',1,'Daring','B78354',80),
('C177344',3,'Daring','B75754',97),
('C182225',3,'Daring','B78354',88),
('C186263',3,'Daring','B52187',98),
('C187358',2,'Daring','B47707',100),
('C192065',3,'Daring','B87293',90),
('C192597',3,'Daring','B87293',81),
('C192889',2,'Daring','B81408',93),
('C193571',1,'Daring','B77218',92),
('C200548',1,'Daring','B77218',80),
('C204291',3,'Daring','B66779',80),
('C205706',3,'Daring','B52187',100),
('C209092',2,'Daring','B96651',78),
('C209765',1,'Daring','B27929',87),
('C212220',3,'Daring','B05226',84),
('C216439',1,'Daring','B27929',98),
('C217708',2,'Daring','B47707',78),
('C218277',1,'Daring','B27929',92),
('C222430',1,'Daring','B75754',91),
('C224697',2,'Daring','B96651',95),
('C225582',3,'Daring','B36934',89),
('C227122',3,'Daring','B05226',88),
('C230405',2,'Daring','B49491',97),
('C230900',3,'Daring','B78354',92),
('C236264',3,'Daring','B05575',99),
('C243097',2,'Daring','B76199',82),
('C244784',1,'Daring','B58031',98),
('C245467',1,'Daring','B78354',86),
('C247617',2,'Daring','B81408',85),
('C247905',3,'Daring','B96651',75),
('C254297',2,'Daring','B76199',83),
('C254742',3,'Daring','B75754',88),
('C258809',2,'Daring','B96651',82),
('C269249',3,'Daring','B75754',84),
('C279791',3,'Daring','B75754',81),
('C294157',1,'Daring','B66905',98),
('C294996',1,'Daring','B58031',89),
('C298871',1,'Daring','B78354',92),
('C306027',2,'Daring','B96651',90),
('C310032',3,'Daring','B96651',96),
('C314502',3,'Daring','B36934',80),
('C316302',1,'Daring','B66905',89),
('C321254',3,'Daring','B36934',84),
('C322445',1,'Daring','B66905',84),
('C323211',2,'Daring','B49491',99),
('C324115',3,'Daring','B96651',80),
('C325410',2,'Daring','B47707',96),
('C326476',1,'Daring','B73390',92),
('C331176',1,'Daring','B58031',85),
('C331517',3,'Daring','B75754',98),
('C332344',3,'Daring','B07623',91),
('C338459',2,'Daring','B96651',95),
('C338965',3,'Daring','B96651',90),
('C339591',1,'Daring','B58031',89),
('C340763',1,'Daring','B27929',95),
('C341948',2,'Daring','B49491',85),
('C342325',2,'Daring','B96651',96),
('C342912',3,'Daring','B47707',95),
('C343170',2,'Daring','B47707',95),
('C350719',2,'Daring','B76199',81),
('C354486',2,'Daring','B47707',96),
('C356010',1,'Daring','B66905',91),
('C363308',3,'Daring','B07623',93),
('C363822',1,'Daring','B77218',78),
('C363947',3,'Daring','B75754',78),
('C369595',3,'Daring','B36934',76),
('C378518',2,'Daring','B47707',91),
('C386027',3,'Daring','B78354',100),
('C389237',3,'Daring','B36934',87),
('C393749',1,'Daring','B27929',91),
('C398978',2,'Daring','B49491',79),
('C400559',2,'Daring','B76199',95),
('C401359',1,'Daring','B75754',92),
('C401411',3,'Daring','B78354',80),
('C402552',2,'Daring','B49208',91),
('C409396',2,'Daring','B76199',84),
('C410692',1,'Daring','B78354',85),
('C414290',2,'Daring','B49491',89),
('C418602',2,'Daring','B81408',76),
('C423480',3,'Daring','B66779',99),
('C423802',2,'Daring','B47707',91),
('C425591',3,'Daring','B75754',75),
('C425910',1,'Daring','B58031',97),
('C439812',3,'Daring','B96651',86),
('C443336',3,'Daring','B78354',76),
('C446761',3,'Daring','B96651',84),
('C452589',3,'Daring','B36934',92),
('C453582',1,'Daring','B78354',99),
('C454213',3,'Daring','B87293',96),
('C455452',3,'Daring','B05575',87),
('C457465',1,'Daring','B77218',75),
('C458661',1,'Daring','B73390',89),
('C459945',1,'Daring','B77218',98),
('C465944',1,'Daring','B58031',99),
('C466985',3,'Daring','B75754',77),
('C471972',1,'Daring','B78354',94),
('C472336',1,'Daring','B27929',91),
('C475626',3,'Daring','B66779',97),
('C478271',3,'Daring','B47707',86),
('C479028',3,'Daring','B75754',90),
('C491356',1,'Daring','B27929',90),
('C499484',3,'Daring','B52187',81),
('C505059',1,'Daring','B77218',78),
('C511953',2,'Daring','B76199',88),
('C512609',3,'Daring','B78354',96),
('C513246',2,'Daring','B49491',97),
('C524937',3,'Daring','B66779',89),
('C525331',3,'Daring','B87293',82),
('C531558',2,'Daring','B49208',85),
('C532568',3,'Daring','B05575',90),
('C538749',3,'Daring','B07623',99),
('C541108',1,'Daring','B73390',91),
('C542558',3,'Daring','B36934',100),
('C548514',2,'Daring','B81408',100),
('C555676',2,'Daring','B76199',97),
('C560115',2,'Daring','B31388',100),
('C561558',3,'Daring','B87293',85),
('C565438',2,'Daring','B47707',86),
('C565978',1,'Daring','B73390',77),
('C571041',2,'Daring','B49208',91),
('C575840',1,'Daring','B66905',83),
('C583603',3,'Daring','B87293',83),
('C585258',2,'Daring','B49208',75),
('C611513',3,'Daring','B75754',83),
('C614758',2,'Daring','B49208',96),
('C615796',1,'Daring','B78354',82),
('C617552',3,'Daring','B47707',81),
('C617612',3,'Daring','B52187',89),
('C617778',2,'Daring','B49208',86),
('C618863',2,'Daring','B81408',98),
('C622723',3,'Daring','B05575',84),
('C629874',2,'Daring','B47707',100),
('C634259',3,'Daring','B96651',96),
('C638626',3,'Daring','B78354',75),
('C638896',3,'Daring','B05575',93),
('C642260',2,'Daring','B31388',92),
('C643017',3,'Daring','B66779',78),
('C643023',3,'Daring','B78354',98),
('C645218',3,'Daring','B96651',92),
('C654331',1,'Daring','B75754',81),
('C655946',3,'Daring','B47707',93),
('C656306',1,'Daring','B77218',86),
('C658210',1,'Daring','B75754',79),
('C663161',2,'Daring','B47707',81),
('C665584',3,'Daring','B87293',76),
('C666937',2,'Daring','B31388',84),
('C666951',3,'Daring','B75754',80),
('C668375',2,'Daring','B81408',99),
('C669357',3,'Daring','B75754',79),
('C669739',3,'Daring','B78354',85),
('C670235',2,'Daring','B76199',81),
('C678050',2,'Daring','B47707',87),
('C678508',3,'Daring','B66779',86),
('C680309',1,'Daring','B73390',80),
('C681894',3,'Daring','B05226',91),
('C687346',3,'Daring','B52187',97),
('C688280',2,'Daring','B49208',89),
('C691449',3,'Daring','B78354',91),
('C691911',1,'Daring','B58031',97),
('C696824',2,'Daring','B96651',96),
('C703753',3,'Daring','B66779',98),
('C711694',3,'Daring','B36934',79),
('C717926',2,'Daring','B76199',89),
('C731367',2,'Daring','B49208',93),
('C736459',1,'Daring','B58031',79),
('C737453',1,'Daring','B75754',90),
('C743440',2,'Daring','B49208',96),
('C745683',2,'Daring','B47707',87),
('C751242',2,'Daring','B49208',87),
('C755540',3,'Daring','B07623',92),
('C758704',3,'Daring','B05575',94),
('C762444',1,'Daring','B66905',78),
('C763675',1,'Daring','B66905',80),
('C778276',3,'Daring','B78354',94),
('C779628',2,'Daring','B49491',86),
('C785064',2,'Daring','B47707',96),
('C794884',3,'Daring','B47707',83),
('C799312',2,'Daring','B96651',98),
('C799352',1,'Daring','B75754',84),
('C800489',3,'Daring','B87293',87),
('C806326',3,'Daring','B05575',84),
('C806901',1,'Daring','B75754',83),
('C809340',3,'Daring','B05226',80),
('C809416',3,'Daring','B07623',84),
('C811125',3,'Daring','B96651',80),
('C815779',3,'Daring','B05226',79),
('C816241',3,'Daring','B36934',76),
('C817167',2,'Daring','B47707',96),
('C824430',1,'Daring','B58031',86),
('C824564',1,'Daring','B78354',98),
('C830742',1,'Daring','B27929',91),
('C831575',2,'Daring','B96651',85),
('C832478',1,'Daring','B58031',86),
('C833621',3,'Daring','B36934',76),
('C834202',3,'Daring','B87293',87),
('C834699',3,'Daring','B78354',95),
('C837687',3,'Daring','B05575',98),
('C842087',2,'Daring','B81408',92),
('C845506',2,'Daring','B76199',97),
('C849159',2,'Daring','B96651',87),
('C852038',1,'Daring','B78354',99),
('C853407',3,'Daring','B47707',93),
('C854821',1,'Daring','B58031',97),
('C855999',2,'Daring','B81408',75),
('C856791',1,'Daring','B77218',81),
('C858633',3,'Daring','B96651',99),
('C859299',1,'Daring','B58031',90),
('C861688',1,'Daring','B66905',82),
('C861967',1,'Daring','B27929',93),
('C862960',3,'Daring','B75754',91),
('C865985',1,'Daring','B75754',83),
('C868942',2,'Daring','B81408',88),
('C871510',2,'Daring','B49491',92),
('C877901',1,'Daring','B75754',90),
('C882203',3,'Daring','B05226',94),
('C882460',1,'Daring','B66905',78),
('C885610',3,'Daring','B96651',95),
('C889767',3,'Daring','B52187',98),
('C890410',1,'Daring','B58031',78),
('C896105',2,'Daring','B81408',93),
('C907046',2,'Daring','B81408',99),
('C907058',3,'Daring','B87293',82),
('C907926',1,'Daring','B73390',97),
('C911324',3,'Daring','B47707',75),
('C912567',2,'Daring','B96651',78),
('C914650',3,'Daring','B75754',98),
('C920426',2,'Daring','B31388',79),
('C924021',3,'Daring','B78354',92),
('C927388',2,'Daring','B76199',94),
('C938333',1,'Daring','B66905',98),
('C948484',1,'Daring','B73390',96),
('C954044',1,'Daring','B77218',83),
('C957436',3,'Daring','B47707',90),
('C959760',2,'Daring','B31388',90),
('C965084',3,'Daring','B78354',95),
('C968745',1,'Daring','B27929',96),
('C969615',3,'Daring','B66779',90),
('C971104',3,'Daring','B78354',87),
('C974825',3,'Daring','B07623',79),
('C976442',2,'Daring','B96651',96),
('C980055',2,'Daring','B49491',86),
('C982021',3,'Daring','B75754',98),
('C982600',2,'Daring','B47707',89),
('C984113',3,'Daring','B87293',89),
('C987922',1,'Daring','B58031',100),
('C990755',1,'Daring','B27929',81),
('C995099',1,'Daring','B58031',99),
('C995309',1,'Daring','B77218',78),
('C997983',3,'Daring','B87293',98),
('C999749',3,'Daring','B05226',90);
/*!40000 ALTER TABLE `seleksi_wawancara` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `waktu_seleksi`
--

DROP TABLE IF EXISTS `waktu_seleksi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `waktu_seleksi` (
  `ID_Seleksi` varchar(20) NOT NULL,
  `Tanggal_Pelaksanaan` date NOT NULL,
  PRIMARY KEY (`ID_Seleksi`),
  CONSTRAINT `waktu_seleksi_ibfk_1` FOREIGN KEY (`ID_Seleksi`) REFERENCES `seleksi_lanjutan` (`ID_Seleksi`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `waktu_seleksi`
--

LOCK TABLES `waktu_seleksi` WRITE;
/*!40000 ALTER TABLE `waktu_seleksi` DISABLE KEYS */;
INSERT INTO `waktu_seleksi` VALUES
('C000550','2023-04-17'),
('C003372','2023-04-19'),
('C005675','2023-04-19'),
('C005939','2023-04-12'),
...
('E963402','2023-05-26'),
('E980305','2023-05-29');
/*!40000 ALTER TABLE `waktu_seleksi` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-05-05 15:32:03
